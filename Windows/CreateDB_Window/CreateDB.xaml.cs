        ...
        private async Task CreateDBTables()
        {
            await Task.Run(() =>
            {
                this.Dispatcher.BeginInvoke(new Action(() =>
                {
                    ...
                    query.Add("CREATE TABLE `invoice_products` (`id` INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, `Invoice_ID` varchar(100) NOT NULL, `Product_ID` varchar(10) NOT NULL, `Name` varchar(45) NOT NULL,`Amount` varchar(45) NOT NULL,`Each_Netto` varchar(45) NOT NULL,`VAT` varchar(3) NOT NULL,`Each_Brutto` varchar(45) NOT NULL, `Netto` varchar(45) NOT NULL,`VAT_Price` varchar(45) NOT NULL,`Brutto` varchar(45) NOT NULL)");
